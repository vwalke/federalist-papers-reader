---
number: 50
title: "Periodical Appeals to the People Considered"
topic: "Against Periodic Appeals"
author: "James Madison (attribution disputed)"
authorCertainty: disputed
publicationKind: newspaper
publicationVenue: "The New-York Packet"
publicationDate: "1788-02-05"
publicationDateLabel: "From the New York Packet. Tuesday, February 5, 1788."
recipient: "To the People of the State of New York."
indexSummary: "Argues scheduled conventions would be too late, too partisan, and too weak to prevent encroachment."
nutshell: "Madison tests the idea of periodic constitutional conventions. Past violations might be beyond repair, while future officials would still have little immediate reason to obey boundaries."
keyArguments:
  - "A remedy at fixed intervals cannot stop current abuses promptly."
  - "Convention delegates would carry the same party conflicts as ordinary politics."
  - "Experience in Pennsylvania showed that review could expose violations without correcting them."
whyItMattered: "The essay continues the search for checks that operate continuously from inside government itself."
talkItOver: "What kinds of accountability must be continuous rather than periodic?"
sources:
